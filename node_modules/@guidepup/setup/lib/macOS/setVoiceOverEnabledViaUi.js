...
exports.setVoiceOverEnabledViaUi = void 0;
const errors_1 = require("../errors");
const runAppleScript_1 = require("./runAppleScript");
async function setVoiceOverEnabledViaUi(credentials) {
    const script = `
...
`;
    try {
        await (0, runAppleScript_1.runAppleScript)(script);
    }
    catch (e) {
        throw new Error(`${errors_1.ERR_MACOS_UNABLE_TO_UPDATE_UI_PREFERENCES}\n\n${e.message}`);
    }
}
exports.setVoiceOverEnabledViaUi = setVoiceOverEnabledViaUi;
