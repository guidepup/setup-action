...
`;
const enableFocusModeVenturaAppleScript = (locale, platformMajor) => {
    ...
    const checkboxPosition = platformMajor < 25 ? "checkbox 2 of group 1" : "checkbox 7 of group 1";
...
async function enableDoNotDisturb() {
    ...
    try {
        if (platformMajor <= 20) {
            ...
            await (0, retryOnError_1.retryOnError)(() => (0, runAppleScript_1.runAppleScript)(enableFocusModeVenturaAppleScript(locale, platformMajor)));
        }
    }
    catch (e) {
