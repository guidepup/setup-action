...
export declare const ERR_MACOS_UNABLE_TO_WRITE_DATABASE_FILE = "Unable to write to the VoiceOver database file";
export declare const ERR_MACOS_UNABLE_TO_WRITE_USER_TCC_DB = "Unable to write to the user TCC.db";
export declare const ERR_MACOS_UNABLE_TO_UPDATE_UI_PREFERENCES = "Unable to enable VoiceOver control via UI preferences";
