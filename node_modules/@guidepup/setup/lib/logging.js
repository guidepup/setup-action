...
exports.handleError = exports.handleWarning = exports.handleComplete = exports.logError = exports.logWarn = exports.logInfo = void 0;
...
function handleWarning(err) {
    ...
    (0, exports.logWarn)("");
    (0, exports.logWarn)(chalk_1.default.bold(chalk_1.default.yellow(`[!] ${chalk_1.default.bold(message.toString())}`)));
    (0, exports.logWarn)("");
    (0, exports.logWarn)("Unable to complete environment setup");
    (0, exports.logWarn)("");
    (0, exports.logWarn)(chalk_1.default.dim("Please raise new issues at: " +
